...
def handle_function_calls(response, contents):
    ...
    contents.extend([function_call_content, func_response_content])
...
with genai.Client(api_key=GEMINI_API_KEY) as client:
    ...
    if response.function_calls:
        response = handle_function_calls(response, contents)
